...
class MigrationErrorUnfinished(_MigrationError):
    ...
    def __str__(self):
        msg = (u'Upgrade of version {} has been attempted and failed. '
               ...
               u'update the  \'click_odoo_migrator\' table yourself.'.format(
                   self.unfinished))
        return msg
...
class MigrationErrorGap(_MigrationError):
    ...
    def __str__(self):
        msg = (u'The --since flag must specify the last executed migration. '
